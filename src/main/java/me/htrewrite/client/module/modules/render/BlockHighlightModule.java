...
public class BlockHighlightModule extends Module {
    ...
    public static final ValueSetting<Double> a = new ValueSetting<>("Alpha", null, 255d, 0d, 255d);
    ...
    public BlockHighlightModule() {
        ...
        blockHighlightManager = HTRewrite.INSTANCE.getBlockHighlightManager();
    ...
    @EventHandler
    private Listener<RenderEvent> renderWorldLastEventListener = new Listener<>(event -> {
        glPushMatrix();
        glEnable(GL_BLEND);
